...
### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1BPtKekEv3?p=74)
...
因此，开发合适的基于微信小程序的汽车预约维修系统，可以方便管理人员对基于微信小程序的汽车预约维修系统的管理，提高信息管理工作效率及查询效率，用户可以在手机上通过微信小程序来订餐，更加的方便，有利于更好的为人们服务。

1.2研究目的

随着互联网技术的快速发展，网络时代的到来，网络信息也将会改变当今社会。各行各业在日常企业经营管理等方面也在慢慢的向规范化和网络化趋势汇合。基于微信小程序的汽车预约维修系统的信息化程度体现在将互联网与信息技术应用于经营与管理，以现代化工具代替传统手工作业。无疑，使用网络信息化管理使信息管理更先进、更高效、更科学，信息交流更迅速。

对于之前基于微信小程序的汽车预约维修系统的管理，大部分都是使用传统的人工方式去管理，这样导致了管理效率低下、出错频率高。而且，时间一长的话，积累下来的数据信息不容易保存，对于查询、更新还有维护会带来不少问题。对于数据交接也存在很大的隐患。如果采用电子化的存储方式就会带来很大的改善，而且给用户的查询带来了很大便利，因此设计一个基于微信小程序的汽车预约维修系统刻不容缓，能够提高信息的管理水平。
## 1.3系统设计思想
